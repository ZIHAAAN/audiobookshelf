...
class ApiRouter {
  ...
  init() {
    ...
    this.router.delete('/authors/combined_alias', AuthorController.middleware.bind(this), AuthorController.deleteCombinedAlias.bind(this))
    ...
    this.router.get('/clearNotifications', NotificationController.middleware.bind(this), NotificationController.clearNotifications.bind(this))
